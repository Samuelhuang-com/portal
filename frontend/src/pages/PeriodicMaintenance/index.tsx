        ...
        schedDrawerItem && (
          <Space>
            ...
            {schedDrawerItem.item_ragic_id && (
              <Tooltip title="在 Ragic 查看原始表單">
                <a
                  href={`https://ap12.ragic.com/soutlet001/periodic-maintenance/6/${schedDrawerItem.item_ragic_id.split('_')[0]}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ color: '#4BA8E8', fontSize: 16, lineHeight: 1 }}
                >
      ...
      title={annualDrawerCell && (
        <Space>
          ...
          {annualDrawerCell.row.item_ragic_id && (
            <Tooltip title="在 Ragic 查看原始表單">
              <a
                href={`https://ap12.ragic.com/soutlet001/periodic-maintenance/6/${annualDrawerCell.row.item_ragic_id.split('_')[0]}`}
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: '#4BA8E8', fontSize: 16, lineHeight: 1 }}
              >
