/**
 * 【商場班表】此檔為 pages/Schedule/Calendar.tsx 的對稱複製版。
...
import {
  mallFetchSchedules, mallFetchScheduleTable,
  mallFetchShifts, mallFetchDepartments,
  ...
  return (
    <div style={{ padding: '24px' }}>
      <Row justify="space-between" align="middle" style={{ marginBottom: 16 }}>
        <Col>
          <Title level={4} style={{ margin: 0 }}>商場月曆式班表</Title>
        </Col>
        <Col>
          <Space>
