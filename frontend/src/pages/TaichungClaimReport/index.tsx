/**
 * 台中核准請款單月報表（2026-09-16 完整複製自 pages/ClaimReport，資料來源改 /taichung-*-report）
 *
 * TAB 順序：
 *   TAB-1  請款單清單（訂單級）
 *   TAB-2  請款單月報明細（品項級）
...
const PAGE_SIZE = 50
const STORAGE_KEY = 'taichung_claim_report_year_month'
...
export default function TaichungClaimReportPage() {
